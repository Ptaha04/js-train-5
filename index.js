...
function concatenateStrings(array, subString) {
  let mainString = array.toString();
  mainString.includes(subString) ? console.log(true) : "";
...
function addTenToEach(array) {
  ...
  for (const element in array) {
    newArray[element] = array[element] + 10;
  }
...
function multiplyByIndex(arr) {
  ...
  for (const element in arr) {
    newArr = [...newArr, arr[element] * element];
  }
  return newArr;
  // Створюємо пустий масив для зберігання результату
  // Проходимо через кожен елемент вхідного масиву
...
function replaceNumbers(arr) {
  ...
  for (const element in arr) {
    if (arr[element] <= 10) {
      newArr[element] = "Less than or equal to 10";
    } else {
      newArr[element] = "Greater than 10";
    }
    newArr = [...newArr];
  }
  return newArr;
